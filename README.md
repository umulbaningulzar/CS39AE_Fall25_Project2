# Streamlit Portfolio & Diabetes Data Dashboard
...
- **📄 Bio:** Short professional bio, highlights, and visualization philosophy.
- **📊 EDA Gallery:** Four different chart types exploring the diabetes dataset, with “how to read this chart” notes and observations.
- **📈 Dashboard:** Interactive filters, KPIs, and linked visuals to explore key patterns in the data.
- **🧭 Future Work:** Next steps for improving the app and a reflection on the design process.
